...
if (os.hostname() == "DESKTOP-GIT4IPL") {
    var Ip = process.env.IpAddress;
} else {
    var Ip = "http://3.109.49.130";
}
    ...
    static s = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                var Access1 = User2.Access1;
                var Access2 = User2.Access2;
                var Access3 = User2.Access3;
                var Access4 = User2.Access4;
                var Access5 = User2.Access5;
                var Access6 = User2.Access6;
                var Access7 = User2.Access7;
                var Access8 = User2.Access8;
                var Access9 = User2.Access9;
                var Access10 = User2.Access10;
                var Access11 = User2.Access11;
                var Access12 = User2.Access12;
                var Access13 = User2.Access13;
                var Access14 = User2.Access14;

                res.render("First", { User2, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static t = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                res.render("User", { User2, User, Ip, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static x = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                res.render("Parking", { User2, a, Ip, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static z = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                res.render("Hotel", { User2, User, Ip, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static B = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                res.render("Restaurant", { User2, User, Ip, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static D = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                res.render("Mall", { User2, User, Ip, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static F = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                res.render("Other", { User2, User, Ip, Access1, Access2, Access3, Access4, Access5, Access6, Access7, Access8, Access9, Access10, Access11, Access12, Access13, Access14 });
    ...
    static G = async (req, res) => {
        try {
            ...
            if (req.session.userid) {
                ...
                if (City && State) {
                    var User3 = await Todo2.find({ UnitType: "OTHER", City: City, State: State });
                } else if (City) {
                    var User3 = await Todo2.find({ UnitType: "OTHER", City: City });
                } else if (State) {
                    var User3 = await Todo2.find({ UnitType: "OTHER", State: State });
                } else {
                    var User3 = await Todo2.find({ UnitType: "OTHER" });
                }
